...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/gk_botz)",
                                     disable_web_page_preview=True)
            return
...
async def button(bot: Client, cmd: CallbackQuery):
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton("Movie Channel 🎥",url=f"https://t.me/{Config.MOVIE_CHANNEL}"),
                     InlineKeyboardButton("Owner 😎", callback_data=f"https://t.me/{Config.OWNER_USERNAME}")],
                    [InlineKeyboardButton("Home 🏡", callback_data="gotohome")]]))
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/Filmone_Request).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/gkbotz).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
